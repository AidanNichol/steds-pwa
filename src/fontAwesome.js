...
import { faBus, faCar, faSlash, faBan, faPoundSign, faTimes, faEdit, faTenge, faHandHolding } from '@fortawesome/free-solid-svg-icons';
import { faClock, faCircle } from '@fortawesome/pro-regular-svg-icons';
console.warn('fa-config', config);

config.showMissingIcons = true;

library.add(faBus, faCar, faSlash, faClock, faBan, faPoundSign, faCircle, faTimes, faEdit, faTenge, faHandHolding);
const L = {
  prefix: 'fas',
  iconName: 'late',
  icon: [
